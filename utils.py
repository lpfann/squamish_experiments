...
def print_df_astable(df, filename, output_root=OUTPUT_PATH, folder="", decimals=2,na_rep="NaN"):
    ...
    output = df.to_latex(multicolumn=True,multirow=True, bold_rows=True, float_format=f"%.{decimals}f",na_rep=na_rep)
    print(output)
