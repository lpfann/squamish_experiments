...
from fri.model.ordinal_regression import ordinal_scores
...
class Job(object):
        ...
        def __init__(self, traindata=None,testdata=None, model=None, modelname=None, setname=None):
        ...
        def run_one_perf_test(self):
            ...
            # Neutral ordinal model 
            # TODO: is this model good enough or should we use a custom model from `linear_models.py` 
            ...
            # Get all three ordinal scores
            result_scores = {}
            testpredict = est.predict(X_test)

            score = l1models.ordinal_scores
            for score_type in ["mze","mae","mmae"]:
                testscore = score(testpredict, y_test, score_type)
                result_scores[score_type] = testscore
